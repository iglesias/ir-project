...
public class SaveFollowersIDs {
	...
	/**
	 * Gets all the IDs of the followers of the twitter identity FOLLOWING and 
	...
	public static void main(String[] args) {
    	...
    	try {
			...
			// Create JSON object, all the required information is in one line
        	...
        	// Store the followers' IDs in a file, using a unique timestamp for
        	// the file's name
